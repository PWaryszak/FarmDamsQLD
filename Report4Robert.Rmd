...
# Define MyFarmer for this report (see Site column in field_data or farmers names)
MyFarmer <- "Robert_Huth"
...
emission_data <- read.csv("MethaneData_PawelToowoomba_Pondi_29.csv") #also on Teams downloaded from deployed Pondi.
